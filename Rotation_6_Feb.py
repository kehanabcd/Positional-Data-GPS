...
## Interpolation
Team1_10Hz.interpolate(method="linear", limit_direction="forward", axis=0).to_csv("{}_10Hz.csv".format(team1), index=0, na_rep="NA")
...
# plot player
first_500_TS = Team1_10Hz.iloc[[0, 100, 200, 300, 400, 500], [3, 4]]
