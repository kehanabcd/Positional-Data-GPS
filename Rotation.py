...
RM_CW = np.array([[np.cos(angle*np.pi/180), -np.sin(angle*np.pi/180)],
                          [np.sin(angle*np.pi/180), np.cos(angle*np.pi/180)]]) # # Rotation Matrix for clockwise

RM_CCW = np.array([[np.cos(angle*np.pi/180), np.sin(angle*np.pi/180)],
                  [-np.sin(angle*np.pi/180), np.cos(angle*np.pi/180)]]) # Rotation Matrix for counterclockwise
...
# plot player
first_500_TS = position.iloc[[0, 100, 200, 300, 400, 500], [3, 4]]
plt.scatter(first_500_TS["X"], first_500_TS["Y"])
traj_500_TS = position.iloc[0: 501, [3, 4]]
plt.scatter(traj_500_TS["X"], traj_500_TS["Y"])
